...
@Getter
public class LoanRequestUpdatedEvent extends DomainEvent {
    ...
    public LoanRequestUpdatedEvent(String aggregateId, String tracerId, String memberId,
                                   String proposalId, String proposalNo, String proposalRefNo,
                                   String proposedCOId, String loanProductId, String loanSchemeId,
                                   String officeId, String projectId, LocalDateTime applicationDate,
                                   Double proposedLoanAmount, Double proposedGrantAmount,
                                   String proposalRemarks, String scannedFileName,
                                   Long loanProductPolicyId, Long loanProductDetailsId,
                                   Integer proposedDurationInMonths, Double interestRate,
                                   Integer noOfInstallments, Double installmentAmount,
                                   Integer recordStatus, Long cohortMappingId,
                                   Long assetPurchaseId, String bufferId, Integer earner,
                                   String memberOwnIncome, String memberFamilyIncome,
